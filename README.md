...
- **[SmartDifficulty Server Mod](smartdifficulty/README.md)**: 100% server-side world day counter (`/day`) and smart difficulty scaling. Mobs progressively equip armor (Day 100 Iron Era, Day 200 Diamond Era with randomized gear/weapons like copper swords), Full Moon sleep prohibition with blood moon alerts, and stat enhancements. See the [SmartDifficulty Guide](smartdifficulty/README.md).
- **[NoTooExpensive Server Mod](notooexpensive/README.md)**: 100% server-side mod removing the vanilla anvil **"Too Expensive!"** limit when combining enchantments and repairing equipment. Caps maximum cost at 39 levels (safe for vanilla clients) and caps exponential prior work penalties at 31 levels. In-game commands (`/nte status`, `/nte reload`). See the [NoTooExpensive Guide](notooexpensive/README.md).
