#!/usr/bin/env bash
# Build script for SmartDifficulty Fabric mod
set -e

DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SERVER_DIR="${1:-/var/lib/pufferpanel/servers/35ca4939}"

echo "=== Building SmartDifficulty Mod ==="
...
out_jar = os.path.join(base_dir, "smart-difficulty-1.0.0.jar")
